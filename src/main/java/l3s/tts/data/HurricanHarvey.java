...
public class HurricanHarvey {
	...
	static void getPartialOrdered(int batch, int nLines) {
		try {
			JsonParser parser = new JsonParser();
			List<JsonTweet> tweets = new ArrayList<HurricanHarvey.JsonTweet>();
			String filename = "/home/hoang/tss/data/harvey_twitter_dataset/02_archive_only/HurricaneHarvey.json";
			BufferedReader br = new BufferedReader(new FileReader(filename));
			String line = null;
			...
			filename = "/home/hoang/tss/data/harvey_twitter_dataset/ordered";
	...
	static void order() {
		try {
			BufferedReader[] br = new BufferedReader[71];
			for (int b = 0; b < 71; b++) {
				String filename = "/home/hoang/tss/data/harvey_twitter_dataset/ordered";
				filename = String.format("%s/partial_%d.json", filename, b);
				br[b] = new BufferedReader(new FileReader(filename));
			}
			JsonParser parser = new JsonParser();
			Queue<JsonTweet> queue = new PriorityQueue<HurricanHarvey.JsonTweet>();
			String line = null;
			for (int b = 0; b < 71; b++) {
				line = br[b].readLine();
				if (line == null) {
			...
			String filename = "/home/hoang/tss/data/harvey_twitter_dataset/ordered/allTweets.json";
			int nTweets = 0;
			BufferedWriter bw = new BufferedWriter(new FileWriter(filename));
			while (queue.size() > 0) {
	...
	static void filterNonEnglishTweets() {
		try {
			...
			String filename = "/home/hoang/tss/data/harvey_twitter_dataset/ordered/allTweets.json";
			BufferedReader br = new BufferedReader(new FileReader(filename));
			filename = "/home/hoang/tss/data/hurricane_harvey/hurricane_harvey.txt";
			BufferedWriter bw = new BufferedWriter(new FileWriter(filename));
			String line = null;
			while ((line = br.readLine()) != null) {
	...
	static void statByDate() {
		try {
			String filename = "/home/hoang/tss/data/hurricane_harvey/hurricane_harvey.txt";
			BufferedReader br = new BufferedReader(new FileReader(filename));
			String line = null;
			...
			filename = "/home/hoang/tss/hurricane_harvey_tweetcount.csv";
			BufferedWriter bw = new BufferedWriter(new FileWriter(filename));
	...
	static void selectTweets() {
		try {
			String filename = "/home/hoang/tss/data/hurricane_harvey/hurricane_harvey.txt";
			BufferedReader br = new BufferedReader(new FileReader(filename));
			filename = "/home/hoang/tss/data/hurricane_harvey/hurricane_harvey_selected_tweets.txt";
			BufferedWriter bw = new BufferedWriter(new FileWriter(filename));

			HashSet<String> selectedDates = new HashSet<String>();
			selectedDates.add("23/8/2017");
			selectedDates.add("24/8/2017");
			selectedDates.add("25/8/2017");
			selectedDates.add("26/8/2017");
			selectedDates.add("27/8/2017");
			selectedDates.add("28/8/2017");
			selectedDates.add("29/8/2017");
			selectedDates.add("30/8/2017");
			selectedDates.add("31/8/2017");
			selectedDates.add("1/9/2017");
			selectedDates.add("2/9/2017");
			selectedDates.add("3/9/2017");
